######################################
# Main python file for Photoshare
# Author: Ruihang Liu and Shuo Han
######################################
# Flask starter code provided by:
...
app.config['MYSQL_DATABASE_PASSWORD'] = '**'  # change this to your personal mySQL database password before running
